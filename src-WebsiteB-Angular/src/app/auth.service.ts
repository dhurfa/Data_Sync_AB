...
export class AuthService {
  ...
  {
    return this.httpClient.post<any>(this.APIUrl+'/Users/Login', loginViewModel).pipe(map(user => {
      if(user)
      {
  ...
  {
    return this.httpClient.post<any>(this.APIUrl+"/Users/Register",signUpViewModel);
  }
